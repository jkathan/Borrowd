...
const initialState = {
  ...
  {itemType: 'tool', item: 'Wrench', borrower: 'john', email: 'fake@email.com', phone: '301-555-555', returnDate: '12/8/19'},
  {itemType: 'tool', item: 'Wrench', borrower: 'bill', email: 'fake@email.com', phone: '301-555-555', returnDate: '12/8/19'},
