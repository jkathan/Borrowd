...
export class BorrowList extends React.Component {
    ...
    render() {
        ...
        sortedList = this.props.borrowList.sort((a, b) => (a.returnDate > b.returnDate) ? 1 : ((b.returnDate > a.returnDate) ? -1 : 0));
...
/*    const loansList = Object.assign(
    ...
    //return {
        borrowList: getVisibleBorrowItem(state.loanList, state.filters)
    //};
